...
// TODO: Define a constant for the tasks file (todolist.json)
define("TODO_FILE", "todolist.json");

// TODO: Create a function to load tasks from the todolist.json file
...
function loadTasks(): array {
    ...
    $data = file_get_contents(TODO_FILE);

    return $data ? json_decode($data, true) : [];
}
// Load tasks from the todolist.json file
$tasks = loadTasks();
...
function saveTasks(array $tasks) : void {
    file_put_contents(TODO_FILE, json_encode($tasks, JSON_PRETTY_PRINT));
}
    ...
    <div class="container">
        <div class="task-card">
            ...
            <form method="POST">
                <div class="row">
                    ...
                    <div class="column column-25">
                        <button type="submit" class="button-primary">Add New Task</button>
                    </div>
                </div>
            </form>
            <!-- Task List -->
            ...
            <ul style="list-style: none; padding: 0;">
                ...
                <button type="submit" class="button button-outline" style="margin-left: 10px;">Delete Task</button>
                     </form>
                        </li>
